            ...
            <div v-else>
                ...
                <form @submit.prevent="submitTable" ref="addTableForm">
                    ...
                    <GlobalCustomDropdown v-model="maximumReservations" :options="numberOptions" option-value="value"
                        ...
                        :showValidation="showValidation" :validation-schema="validations.maximumReservations" />
                    ...
                    <GlobalCustomDropdown v-model="durationImplementation" :options="numberOptions" option-value="value"
                        ...
                        :showValidation="showValidation" :validation-schema="validations.durationImplementation" />

                    <!-- Description in Arabic -->
                    <div class="form-group">
                        <label class="label">{{ $t('menu.meal_description_ar') }}</label>
                        <div class="position-relative">
                            <textarea v-model="descriptionAr" @input="descriptionArTouched = true" name="description_ar"
                                class="main_input main_area" :class="{ 'is-invalid': descriptionArError }"
                                :placeholder="$t('menu.meal_description_ar')" rows="4"></textarea>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="position-relative">
                            <textarea v-model="descriptionEn" @input="descriptionEnTouched = true" name="description_en"
                    ...
                    <div class="form-group">
                        ...
                        <div class="employee-input-wrapper">
                            <input v-model="employeeNameInput" type="text" class="main_input employee-input"
                                :class="{ 'is-invalid': showEmployeeError }"
                                :placeholder="$t('service.employee_name_placeholder')" />
                            <button type="button" class="custom-btn md add-employee-btn" @click="addEmployee"
                        ...
                        <div v-if="employeesList.length > 0" class="employees-list mt-3">
                            <div v-for="(employee, index) in employeesList" :key="index" class="employee-item">
                                <span class="employee-name">{{ employee }}</span>
                                <button type="button" class="delete-employee-btn" @click="removeEmployee(index)"
                    ...
                    <div class="form-group working-hours-section">
                        ...
                        <div class="day-row current-input">
                            ...
                            <div class="day-dropdown-wrapper">
                                ...
                                <Dropdown v-model="currentDay.dayName" :options="daysOfWeek" optionLabel="label"
                                    optionValue="value" :placeholder="$t('workingTime.select_day')" class="day-dropdown" />
                            </div>
                            ...
                            <!-- Time To -->
                            <div class="time-input-wrapper">
                                <flat-pickr v-model="currentDay.timeTo" :config="getTimeToPickrConfig(currentDay)" class="custom-time"
                        ...
                        <div class="days-list" v-if="savedDays.length > 0">
                            <div v-for="(day, index) in savedDays" :key="day.id" class="day-row saved-row">
                                ...
                                <!-- Time To -->
                                <div class="time-input-wrapper">
                                    <flat-pickr v-model="day.timeTo" :config="getTimeToPickrConfig(day)" class="custom-time"
                                        :placeholder="$t('workingTime.time_to')" />
                                    <i class="far fa-clock time-icon-end"></i>
                                </div>
...
globalStore.subtitle = t('menu.edit_service');
...
// Submit service update function
const submitTable = async () => {
    ...
    if (!isValid || employeesList.value.length === 0 || savedDays.value.length === 0) {
        ...
        try {
            ...
            const res = await axios.post(`provider/services/${id}/update`, fd, config.value);

            if (res.data.key === 'success') {
                successDialog.value = true;
                successToast(res.data.msg || t('menu.service_updated_successfully'));
            ...
            errorToast(t('menu.error_updating_service'));
        } finally {
