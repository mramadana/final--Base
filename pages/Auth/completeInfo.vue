...
// refs
const { lat, lng, selectedAddress, token, user, device_id } =
...
const submitStep1 = async () => {
    ...
    try {
        ...
        const res = await axios.post(
            "provider/auth/complete-account-first-step",
            fd,
            config.value,
        );
        ...
        if (res.data && res.data.key == "success") {
            ...
            errorToast(
                res.data?.msg || "حدث خطأ أثناء حفظ بيانات المرحلة الأولى",
            );
        }
    } catch (error) {
...
const submitStep2 = async () => {
    ...
    try {
        ...
        const res = await axios.post(
            "provider/auth/complete-account-second-step",
            fd,
            config.value,
        );
        ...
        if (res.data && res.data.key == "success") {
            ...
            errorToast(
                res.data?.msg || "حدث خطأ أثناء حفظ بيانات المرحلة الثانية",
            );
        }
    } catch (error) {
...
const submitStep3 = async () => {
    ...
    try {
        ...
        const res = await axios.post(
            "provider/auth/complete-account",
            fd,
            config.value,
        );
        ...
        if (res.data && res.data.key == "success") {
            ...
            errorToast(
                res.data?.msg || "حدث خطأ أثناء حفظ بيانات المرحلة الثالثة",
            );
        }
    } catch (error) {
...
const handleSubmit = async () => {
    if (currentStep.value === 1) {
        ...
        const profileImageValid =
            profileImageUploader.value?.validate() || false;
